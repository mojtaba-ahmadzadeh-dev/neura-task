...
export class UserController {
  ...
  changeRole(@Param('id') id: string, @Body() updateUserRoleDto: UpdateUserRoleDto) {
  ...
  updateUser(@Body() updateUserDto: UpdateUserDto, @UploadedFile() avatar?: Express.Multer.File) {
