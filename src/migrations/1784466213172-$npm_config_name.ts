...
export class $npmConfigName1784466213172 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createForeignKey(
      "workspace_members",
      new TableForeignKey({
        name: "FK_workspace_members_workspaceId",
    ...
    await queryRunner.createForeignKey(
      "workspace_members",
      new TableForeignKey({
        name: "FK_workspace_members_userId",
        columnNames: ["userId"],
        referencedTableName: "users",
        referencedColumnNames: ["id"],
        onDelete: "CASCADE",
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.dropForeignKey(
      "workspace_members",
      "FK_workspace_members_workspaceId",
    );

    await queryRunner.dropForeignKey(
      "workspace_members",
      "FK_workspace_members_userId",
    );

    await queryRunner.dropForeignKey(
      "workspaces",
      "FK_workspaces_ownerId",
    );
