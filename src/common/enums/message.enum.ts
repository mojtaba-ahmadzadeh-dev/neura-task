export enum AuthMessage {
  ...
  OTP_VERIFIED_SUCCESS = 'تأیید هویت با موفقیت انجام شد',
  ...
  TOKEN_REFRESHED_SUCCESS = 'توکن با موفقیت تازه‌سازی شد',
  GOOGLE_LOGIN_SUCCESS = 'ورود با گوگل با موفقیت انجام شد',
  GOOGLE_REGISTER_SUCCESS = 'ثبت‌نام و ورود با گوگل با موفقیت انجام شد',
  FORGOT_PASSWORD_SUCCESS = 'در صورت وجود حساب کاربری، کد بازیابی ارسال شد',
  USER_NOT_FOUND = 'کاربر یافت نشد',
  USER_EXISTS = 'کاربر از قبل وجود دارد',
  USER_INACTIVE = 'حساب کاربری شما غیرفعال شده است',
  ...
  INVALID_LOGIN_METHOD = 'روش ورود نامعتبر است',
  INVALID_OTP = 'کد تأیید اشتباه است',
  OTP_EXPIRED = 'کد تأیید منقضی شده است',
  REFRESH_TOKEN_REQUIRED = 'Refresh token ارائه نشده است',
  REFRESH_TOKEN_INVALID = 'Refresh token نامعتبر یا منقضی شده است',
